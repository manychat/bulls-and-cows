...
final class Version20200219191610 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE moves (id UUID NOT NULL, game_id UUID NOT NULL, number INT NOT NULL, bulls SMALLINT NOT NULL, cows SMALLINT NOT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN moves.number IS \'(DC2Type:number)\'');
