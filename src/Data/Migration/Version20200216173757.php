...
final class Version20200216173757 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE games (id UUID NOT NULL, player_id UUID NOT NULL, level CHAR(4) NOT NULL, number INT NOT NULL, result BOOLEAN DEFAULT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN games.number IS \'(DC2Type:number)\'');
